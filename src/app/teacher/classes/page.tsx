...
import { mockClasses, ClassItem } from '@/lib/mock-data';
...
const mockClassQuizzes = [
  { id: '1', title: 'Derivatives Quiz', score: 85, maxScore: 100, status: 'completed' },
  { id: '2', title: 'Integration Test', score: null as number | null, maxScore: 100, status: 'upcoming', date: '2025-01-20' },
];
...
export default function ClassesPage() {
  ...
  useEffect(() => {
    const currentUser = getCurrentUser(); // should return User | null
    setUser(currentUser);
  }, []);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-center space-x-3">
                  <div
                    className={`w-3 h-3 rounded-full ${classItem.color}`}
                  ></div>
        ...
        <div className="lg:col-span-3">
          <Card className="border-0 shadow-lg mb-6">
            <CardHeader
              className={`${selectedClass.color} text-white rounded-t-lg`}
            >
